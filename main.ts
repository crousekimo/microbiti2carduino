...
namespace microbiti2carduino {
    ...
    //% block="arduino car power|value1 $value1 value2 $value2|value3 $value3 pin4 $value4"
    //% weight=92
    export function setcarpower2(value1: number, value2: number, value3: number, value4: number) {
